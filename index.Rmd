...
* **Lack of research and use of theory**

  * Most open science proponents are scientists themselves, not specialized in psychology, let alone the subdomain behavior change science. The consequence is that thinking about change is often not structured according to present theory and evidence about behavior change. A minimal solution could be consulting behavior change resources (e.g. https://effectivebehaviorchange.com); ideally, national funders fund qualitative and quantitative research to map the determinants of the relevant behaviors.

  * Lack of research into personal determinants and environmental conditions that determine whether scholars and institutions:
        
        * Adopt Open Scholarship workflows
        
        * Preregister studies
    
        * Share data
    
        * Share materials, source code, and other products
